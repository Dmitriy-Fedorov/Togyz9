...
public class AI_v2 {
	...
	void setPlayground(Desk player_1,Desk player_0,Kazan Kazan_1,Kazan Kazan_0){
		player[1] = player_1;
		player[0] = player_0;
		Kazan[1] = Kazan_1;
		Kazan[0] = Kazan_0;
	...
	public int[] dumbTreePlay_v2(int player_,String getArray, int dummy_width,boolean echo){
		
		int[] scoreTemp = new int[9], tophod = new int[3];
		int tempDest;
		...
		tophod = getTopHod(scoreTemp,"getArrey");
				//print_T9.doMove(i%2, storeMove[i], virtDesk[1], virtDesk[0], virtKazan[1], virtKazan[0],false);
				//print_T9.printDesk(i%2, virtDesk[1], virtDesk[0], virtKazan[1], virtKazan[0]);
	...
	private int[] getTopHod(int[] scoreTemp, String array){
		int max1=0,max2=0,max3=0,temp=-1,tempTop;
		int[] top3 = {0,0,0};
